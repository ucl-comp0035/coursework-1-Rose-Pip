...
if __name__=='__main__':
    ...
    '''
    df_2021=pd.read_csv(r'raw data/Borough_tree_list_2021.csv', low_memory=False)
    ...
    df_2018=pd.read_excle(r'raw data/london_street_trees_gla_20180214.xlsx')
    ...
    df_pre_21=df_cl_21.to_csv(r'C:\Users\yis27\Autodesk\Downloads\Borough_tree_list_2021_cleaned.csv')
